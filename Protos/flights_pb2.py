...
_AIRTIMERESPONSE = _descriptor.Descriptor(
  name='AirtimeResponse',
  full_name='nycflights.AirtimeResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='airtimeAtOrigin', full_name='nycflights.AirtimeResponse.airtimeAtOrigin', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AIRTIMERESPONSE.fields_by_name['airtimeAtOrigin'].message_type = _AIRTIMEATORIGIN
...
DESCRIPTOR.message_types_by_name['AirtimeResponse'] = _AIRTIMERESPONSE
...
AirtimeResponse = _reflection.GeneratedProtocolMessageType('AirtimeResponse', (_message.Message,), {
  'DESCRIPTOR' : _AIRTIMERESPONSE,
  '__module__' : 'flights_pb2'
  # @@protoc_insertion_point(class_scope:nycflights.AirtimeResponse)
  })
_sym_db.RegisterMessage(AirtimeResponse)
